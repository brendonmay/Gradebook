    ...
    'courses.createFirstCourse'(course, year) {
        ...
        CourseWeighting.insert({
            ...
            courseworkAssessmentTypes: [
                { assessmentType: "Quiz", assessmentWeight: 10, assessmentTypeId: 1 },
                { assessmentType: "Assignment", assessmentWeight: 25, assessmentTypeId: 2 },
                { assessmentType: "Test", assessmentWeight: 35, assessmentTypeId: 3 }
            ],
            finalAssessmentTypes: [
                { assessmentType: "Culminating Task", assessmentWeight: 15, assessmentTypeId: 1 },
                { assessmentType: "Final Exam", assessmentWeight: 15, assessmentTypeId: 2 }
            ]
        });
