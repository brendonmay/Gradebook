...
function assignFinalEvalButtonGradeBookComplete() {
...
function resetAddStudentsModalForm() {
    return new Promise(function (resolve, reject) {
...
function createAssessmentButtonEvent() {
    return new Promise(function (resolve, reject) {
...
function addStudentsButtonGradebookComplete() {
    resetAddStudentsModalForm().then(function () {
...
Template.gradeBookChart.events({
    ...
    'click .addStudentsButtonGradebook': function () {
        $('#addStudentsModal').modal({
            dismissible: true,
            complete: function () {
                addStudentsButtonGradebookComplete();
            }
