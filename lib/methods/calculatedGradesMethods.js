...
function determineOverallCategoryGrade(ownerId, courseId, studentId, category, readFromThis) {
    if (readFromThis){
                        ...
                        for (var w = 0; w < assessments.length; w++) {
                            if (assessments[w].assessmentId == assessmentId) {
                                ...
                                if (K) {
                                    ...
                                    var newOverallCategoryGradeK = determineOverallCategoryGrade(Meteor.userId(), courseId, studentId, "K", studentsArray);
                                ...
                                if (A) {
                                    ...
                                    var newOverallCategoryGradeA = determineOverallCategoryGrade(Meteor.userId(), courseId, studentId, "A", studentsArray);
                                ...
                                if (T) {
                                    ...
                                    var newOverallCategoryGradeT = determineOverallCategoryGrade(Meteor.userId(), courseId, studentId, "T", studentsArray);
                                ...
                                if (C) {
                                    ...
                                    var newOverallCategoryGradeC = determineOverallCategoryGrade(Meteor.userId(), courseId, studentId, "C", studentsArray);
